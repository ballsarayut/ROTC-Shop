...
async function fix() {
  ...
  const expected = [
    ...
    },
    {
      ...
      category: "ชุดฝึก/เครื่องแบบ",
      stock: 1000,
      imageUrl: findImg(["หมวกแบเร่ต์", "แบเร่ต์"]),
      sizes: ["5", "6", "7", "8"],
      createdAt: new Date().toISOString()
    },
    {
    ...
    },
    {
      ...
      category: "รองเท้าจังเกิ้ลหนังแท้สีดำ",
      stock: 1000,
      imageUrl: findImg(["เหล็กชิดเท้าสีดำ", "ชิดเท้า"]),
      createdAt: new Date().toISOString()
    },
    {
      id: "prod-7",
      ...
      category: "ชุดฝึก/เครื่องแบบ",
      stock: 1000,
      imageUrl: findImg(["เครื่องหมาย นศท.", "วิทยฐานะ"]),
      createdAt: new Date().toISOString()
    },
    {
      id: "prod-8",
      ...
      category: "รองเท้าจังเกิ้ลหนังแท้สีดำ",
      stock: 1000,
      imageUrl: findImg(["ถุงเท้าลูกฟูก", "ถุงเท้า"]),
      createdAt: new Date().toISOString()
    },
    {
      id: "prod-9",
    ...
    },
    {
      ...
      category: "ชุดฝึก/เครื่องแบบ",
      stock: 1000,
      imageUrl: findImg(["ปักป้ายชื่อ", "ป้ายชื่อ"]),
      createdAt: new Date().toISOString()
    },
    {
      id: "prod-11",
      ...
      category: "ชุดฝึก/เครื่องแบบ",
      stock: 1000,
      imageUrl: findImg(["เครื่องหมายสถานศึกษา", "ปักเครื่องหมายสถานศึกษา"]),
      createdAt: new Date().toISOString()
    },
    {
      id: "prod-12",
      ...
      category: "ชุดฝึก/เครื่องแบบ",
      stock: 1000,
      imageUrl: findImg(["เย็บติดเครื่องหมาย", "รวม 7 ชิ้น"]),
      createdAt: new Date().toISOString()
    },
    {
      id: "prod-13",
      ...
      stock: 1000,
      imageUrl: findImg(["เครื่องสนาม (เป้", "ค่าเครื่องสนาม", "อุปกรณ์สนาม"]),
      createdAt: new Date().toISOString()
    },
    {
      id: "prod-14",
      ...
      category: "ชุดฝึก/เครื่องแบบ",
      stock: 1000,
      imageUrl: findImg(["เครื่องหมายจิตอาสา", "จิตอาสา"]),
      createdAt: new Date().toISOString()
    }
  ];
